...
with right_col:
    st.subheader("No. of Unique Products")
    st.subheader(f"{ptotal}")
...
a_col.plotly_chart(fig_by_product, use_container = True)
...
b_col.plotly_chart(fig_by_city, use_container_witdh = True)
...
c_col.plotly_chart(fig_by_month, use_container = True)
